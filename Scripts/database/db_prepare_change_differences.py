...
def insert_missing_changes(disaster_id, disaster_area, disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days):
...
if __name__ == "__main__":
    ...
    for disaster_id in disaster_ids:
        for period in periods:
            ...
            print(f"Getting missing changes for {disaster_area} {disaster_date.year}")
            get_missing_changes_for_disaster(disaster_id, sample_size, sample, disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days)
            print(f"Inserting missing changes for {disaster_area} {disaster_date.year}")
            insert_missing_changes(disaster_id, disaster_area[0], disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days)
