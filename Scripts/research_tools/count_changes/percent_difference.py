...
def percentage_difference_full_period(disaster_id, pre_disaster_days, imm_disaster_days, post_disaster_days):
    ...
    changes_per_day_file_path = f"Results/ChangeCounting/disaster{disaster_id}/data/{pre_disaster_days}_{imm_disaster_days}_{post_disaster_days}_changes_per_day.csv"
    ...
    percent_difference_file_path = f"Results/ChangeCounting/disaster{disaster_id}/data/{pre_disaster_days}_{imm_disaster_days}_{post_disaster_days}_percent_difference.csv"
...
def percentage_difference_time_series(disaster_id, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length):
    ...
    data_changes_per_day = pd.read_csv(f"Results/ChangeCounting/disaster{disaster_id}/data/{pre_disaster_days}_{imm_disaster_days}_{post_disaster_days}_changes_per_day.csv")
    ...
    percent_difference_time_series_file_path = f"Results/ChangeCounting/disaster{disaster_id}/data/{pre_disaster_days}_{imm_disaster_days}_{post_disaster_days}_{interval_length}_percent_difference_time_series.csv"
...
if __name__ == "__main__":
    ...
    for disaster_id in range(1,7):
        ...
        #percentage_difference_full_period(disaster_id, pre_disaster_days, imm_disaster_days, post_disaster_days)

        percentage_difference_time_series(disaster_id, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length=1)
        percentage_difference_time_series(disaster_id, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length=7)
        percentage_difference_time_series(disaster_id, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length=30)