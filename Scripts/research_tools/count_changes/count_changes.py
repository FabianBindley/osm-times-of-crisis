...
def compute_total_number_changes_across_disasters(periods, disaster_ids):
    ...
    total_counts = pd.DataFrame(columns=headers, data=np.zeros((4, 4)))
...
def generate_count_by_interval_length(disaster_id, disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length):
    ...
    for disaster_id in range(1,7):
        for prophet_model in prophet_model_bools: # Currently unused
            for period in periods:
                ...
                generate_count_by_interval_length(disaster_id, disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length=1)
                generate_count_by_interval_length(disaster_id, disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length=7)
                generate_count_by_interval_length(disaster_id, disaster_date, pre_disaster_days, imm_disaster_days, post_disaster_days, interval_length=30)
