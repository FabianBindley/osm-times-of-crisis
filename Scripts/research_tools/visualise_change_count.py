...
if __name__ == "__main__":
    ...
    resolutions = {1: 5, 2: 5, 3:5, 4:5, 5:5, 6:5}
    ...
    for disaster_id in range(1,7):
        ...
        m.save(f"./Results/ChangeDensityMapping/charts/disaster_map_{disaster_id}_res_{resolution}.html")  # Save the map to an HTML file
        m.save(f"visualisation-site/public/maps/change_count/disaster_map_{disaster_id}_res_{resolution}.html")  # Save the map to an HTML file
