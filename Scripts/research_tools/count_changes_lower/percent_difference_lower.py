...
if __name__ == "__main__":
    ...
    # Define the periods before and after the disaster we want to compute the % diff for. Pre-disaster can be negative
    ...
    for disaster_id in range(1,7):
        for resolution in resolutions:
            ...
            generate_percentage_difference_for_polygons(disaster_id, disaster_geojson_encoded, resolution, pre_disaster_days, post_disaster_days)
